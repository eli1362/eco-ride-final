...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "<pre>";
    echo "Searching for Drivers on Date: $date | Time: $departure_time | Passengers: $passenger\n";
    echo "SQL Query for Exact Match:\n";
    echo "SELECT * FROM drivers WHERE date = '$date' AND departure_time = '$departure_time' AND remaining_seats >= '$passenger'";
    echo "</pre>";
