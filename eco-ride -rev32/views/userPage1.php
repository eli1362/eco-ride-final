                ...
                <table class="history-table">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<tr>
                            <td data-label='Date de réservation' class='history-data-label' ><span class='user-info-reserve history-data-label'>$reservation_date</span></td>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Simulating fetching full_name (replace with actual user data)
        const fullName = localStorage.getItem('full_name') || "Guest"; // Fallback to "Guest" if not set
        ...
        creditBtn.addEventListener("click", function (event) {
            ...
            if (isCreditVisible) {
                creditText.innerHTML = `${fullName}, you have 150 credits from all your reservations. If you reach 300 credits, you can get a 40% discount on your next reservation.`;
