    ...
    <div class="nav">
        ...
        <div class="menu-icon__wrapper">
            <ul class="menu">
                ...
                <li class="menu__item">
                    <a href="loginPage.php" class="menu__link">Logout</a>
                </li>
            ...
            <div class="nav-menu">
                <ul class="mobile-menu">
                    ...
                    <li class="mobile-menu__item">
                        <a href="loginPage.php" class="mobile-menu__link">Logout</a>
                    </li>
...
<div class="container">
    ...
    <?php if (isset($_SESSION['error_message'])) : ?>
        <h3 class="error profits__first-title">
    ...
    <?php if (!empty($driver_name) && !empty($date) && !empty($departure_time)) : ?>
        <h3 style="font-family: 'Montserrat-semiBold',serif;margin-top: 2rem" class="driver-info">You reserved the driver : <strong style="color: var(--black-text)"><?= htmlspecialchars($driver_name); ?></strong><br><br>
            ...
            <h4 style="color: var(--dark-green) ;font-family: 'Montserrat-semiBold', serif;margin-bottom: 2rem">If for any reason you don't want it, you can cancel your travel by clicking this button.</h4>
        </h3>
