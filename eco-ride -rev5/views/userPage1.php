       ...
       <!-- Dashboard Actions -->
        <section class="dashboard-actions profits-wrappers dashboards-wrapper">
            <div class="action-card profits-wrapper dashboard-wrapper">
                ...
                <a href="car-reservation-user-page.php" class="action-card__btn search-btn dashboard-btn">Réservez maintenant</a>
            </div>
            <div class="action-card profits-wrapper dashboard-wrapper">
                ...
                <a href=#" class="action-card__btn search-btn dashboard-btn">Voir l'historique</a>
            </div>
            <div class="action-card profits-wrapper dashboard-wrapper">
