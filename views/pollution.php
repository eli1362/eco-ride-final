...
$driver_name = isset($_GET['driver_name']) ? $_GET['driver_name'] : 'Unknown';
$passenger = isset($_GET['passenger']) ? $_GET['passenger'] : 1;
$date = isset($_GET['date']) ? $_GET['date'] : 'Unknown';
$departure_time = isset($_GET['departure_time']) ? $_GET['departure_time'] : 'Unknown';
$reservation_id = isset($_GET['reservation_id']) ? $_GET['reservation_id'] : 'Unknown';
?>
