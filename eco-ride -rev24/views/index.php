...
<header class="header">
    ...
    <!-- Reservation Section (only visible when user is logged in) -->
    <?php ?>
    <!-- Reservation Section (only visible when user is logged in) -->
    ...
    <?php else: ?>
        <p class="alert-message" style="color: red;">Vous devez être connecté pour effectuer une réservation.</p>
    <?php endif; ?>
