...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $created_by = $_SESSION['user_id'];  // Logged-in admin

    // Insert employee (role_id = 2 for employees)
    $sql = "INSERT INTO users (full_name, email, password, phone_number, role_id, created_by) VALUES (?, ?, ?, ?, 2, ?)";
    $stmt = $db->prepare($sql);
    $stmt->bind_param("ssssi", $full_name, $email, $password, $phone, $created_by);
    ...
    <div class="container">
        <form method="POST" class="car-rental-form form-roles form_admin">
            ...
            <div class="form-group form-group-roles">
                <label class="label" for="price">Full Name :</label>
                <input type="text" name="label" placeholder="Full Name" required><br>
            </div>
