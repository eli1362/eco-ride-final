...
<head>
    ...
    <title>EcoRide - Forgot Password</title>
...
<main class="login__wrapper">
    <section class="container-login">
        <div class="login-container">
            <div class="container">
                <form action="auth/forgot_password.php" method="POST" class="login-form">
                    <div class="login-form-group forgot-password__form">
                        <label for="email" class="login__title">Entrez votre email pour envoyer votre mot de passe:</label>
