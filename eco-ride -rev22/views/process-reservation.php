            ...
            <?php foreach ($availableDrivers as $driver): ?>
                <div class="driver-card">
                    ...
                    <div class="driver-details">
                        ...
                        <p>Rating: <?php echo htmlspecialchars($driver['rating']); ?> ⭐</p>
                        <p>Price: $<?php echo htmlspecialchars($driver['price']); ?></p>
                        <p>Departure Time: <?php echo htmlspecialchars($driver['departure_time']); ?></p>
                        <p>Date: <?php echo htmlspecialchars($driver['date']); ?></p>
