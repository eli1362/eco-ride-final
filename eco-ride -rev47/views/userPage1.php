...
<head>
    ...
    <script>
        function toggleFields() {
            ...
            document.getElementById('chauffeurFields').style.display = (role === 'chauffeur' || role === 'both') ? 'block' : 'none';
        }
...
<main class="main">
    ...
    <div class="container">
        ...
        <form class="car-rental-form form-roles" method="post" action="save_driver.php" enctype="multipart/form-data">
            ...
            <div class="form-group ">
                <label class="label" for="role">Choisissez votre rôle :</label>
                <select class="form-control role-control" name="role" id="role" onchange="toggleFields()">
            ...
            <div id="chauffeurFields" style="display:none;">
                ...
                <div class="form-group form-group-roles">
                    ...
                    <input class="form-control form-control-roles" type="date" name="date" required><br>
                </div>
                ...
                <div class="form-group form-group-roles">
                    ...
                    <input class="form-control form-control-roles" type="text" name="plate_number" required><br>
                </div>

                <div class="form-group form-group-roles">
                    <label class="label" for="registration_date">Date de première immatriculation :</label>
                ...
                <div class="form-group form-group-roles">
                    ...
                    <input class="form-control form-control-roles" type="text" name="model" required><br>
                </div>

                <div class="form-group form-group-roles">
                    <label class="label" for="color">Couleur :</label>
                    <input class="form-control form-control-roles" type="text" name="color" required><br>
                </div>

                <div class="form-group form-group-roles">
                    <label class="label" for="color">Marque :</label>
