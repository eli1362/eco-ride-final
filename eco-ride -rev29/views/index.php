...
if (!isset($_SESSION['user_id'])) {
    // Redirect to login page if not logged in, with an error message
    $_SESSION['error_message'] = "Vous devez être connecté pour réserver un trajet.";  // Error message in French
    header("Location:loginPage.php");  // Change to your login page
    exit();
}
        ...
        <div class="container">
            ...
            <div class="car-rental-menu">
                <?php if ($error_message): ?>
                    <h3 class="error-message__title" style="color: red; font-weight: bold;">
